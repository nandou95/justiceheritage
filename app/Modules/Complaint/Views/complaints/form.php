    ...
    <form class="bo-form needs-validation" method="post" action="<?= esc($action) ?>" enctype="multipart/form-data" novalidate
        ...
        <div class="bo-wizard" data-wizard>
            <div class="bo-wizard-progress" aria-live="polite">
                <div class="bo-wizard-steps" role="list">
                    <button type="button" class="bo-wizard-step is-active" data-wizard-indicator="1" role="listitem">
                        ...
                        <span class="bo-wizard-step-label"><?= esc(lang('Backoffice.cmp_wizard_step1_short')) ?></span>
                    </button>
                    ...
                    <button type="button" class="bo-wizard-step" data-wizard-indicator="2" role="listitem">
                        ...
                        <span class="bo-wizard-step-label"><?= esc(lang('Backoffice.cmp_wizard_step2_short')) ?></span>
                    </button>
                    <div class="bo-wizard-connector" aria-hidden="true"></div>
                    <button type="button" class="bo-wizard-step" data-wizard-indicator="3" role="listitem">
                        <span class="bo-wizard-step-index">3</span>
                        <span class="bo-wizard-step-label"><?= esc(lang('Backoffice.cmp_wizard_step3_short')) ?></span>
                    </button>
                    <div class="bo-wizard-connector" aria-hidden="true"></div>
                    <button type="button" class="bo-wizard-step" data-wizard-indicator="4" role="listitem">
                        <span class="bo-wizard-step-index">4</span>
                        <span class="bo-wizard-step-label"><?= esc(lang('Backoffice.cmp_wizard_step4_short')) ?></span>
                    </button>
                    <div class="bo-wizard-connector" aria-hidden="true"></div>
                    <button type="button" class="bo-wizard-step" data-wizard-indicator="5" role="listitem">
                        <span class="bo-wizard-step-index">5</span>
                        <span class="bo-wizard-step-label"><?= esc(lang('Backoffice.cmp_wizard_step5_short')) ?></span>
                    </button>
                </div>
                <p class="bo-wizard-status" data-wizard-status>
                    <?= esc(lang('Backoffice.cmp_wizard_progress', [1, $totalSteps])) ?>
                </p>
            </div>

            <div class="bo-wizard-pane is-active" data-wizard-step="1">
                <fieldset class="bo-form-section">
                    <legend class="bo-form-section-title"><?= esc(lang('Backoffice.cmp_wizard_step1_title')) ?></legend>
                    <p class="bo-wizard-step-lead"><?= esc(lang('Backoffice.cmp_wizard_step1_lead')) ?></p>
                    <div class="row g-3">
                        <div class="col-12">
            ...
            <div class="bo-wizard-pane" data-wizard-step="2" hidden>
                <fieldset class="bo-form-section">
                    <legend class="bo-form-section-title"><?= esc(lang('Backoffice.cmp_wizard_step2_title')) ?></legend>
                    <p class="bo-wizard-step-lead"><?= esc(lang('Backoffice.cmp_wizard_step2_lead')) ?></p>
            ...
            <div class="bo-wizard-pane" data-wizard-step="3" hidden>
                <fieldset class="bo-form-section">
                    <legend class="bo-form-section-title"><?= esc(lang('Backoffice.cmp_wizard_step3_title')) ?></legend>
                    <p class="bo-wizard-step-lead"><?= esc(lang('Backoffice.cmp_wizard_step3_lead')) ?></p>
                    <div class="row g-3">
                        <div class="col-12 col-lg-<?= ! empty($hasWitness) ? '4' : '6' ?>">
                            <?php $partySelect('complainant_ids', 'complainant_ids[]', lang('Backoffice.cmp_field_complainants'), $people, $complainants, true); ?>
                        </div>
                        <div class="col-12 col-lg-<?= ! empty($hasWitness) ? '4' : '6' ?>">
                            <?php $partySelect('defendant_ids', 'defendant_ids[]', lang('Backoffice.cmp_field_defendants'), $people, $defendants, true); ?>
                        </div>
                        <?php if (! empty($hasWitness)): ?>
                            <div class="col-12 col-lg-4">
                                <?php $partySelect('witness_ids', 'witness_ids[]', lang('Backoffice.cmp_field_witnesses'), $people, $witnesses, false); ?>
                            </div>
                        <?php endif; ?>
                    </div>
                </fieldset>
            ...
            <div class="bo-wizard-pane" data-wizard-step="4" hidden>
                <fieldset class="bo-form-section">
                    <legend class="bo-form-section-title"><?= esc(lang('Backoffice.cmp_wizard_step4_title')) ?></legend>
                    <p class="bo-wizard-step-lead"><?= esc(lang('Backoffice.cmp_wizard_step4_lead')) ?></p>
            ...
            <div class="bo-wizard-pane" data-wizard-step="5" data-wizard-review hidden>
                <fieldset class="bo-form-section">
                    <legend class="bo-form-section-title"><?= esc(lang('Backoffice.cmp_wizard_step5_title')) ?></legend>
                    <p class="bo-wizard-step-lead"><?= esc(lang('Backoffice.cmp_wizard_step5_lead')) ?></p>
                    <div class="bo-wizard-review" data-cmp-review>
                        <article class="bo-wizard-review-card">
                            <header>
                                <h3><?= esc(lang('Backoffice.cmp_wizard_step1_title')) ?></h3>
                                <button type="button" class="btn btn-link btn-sm" data-wizard-edit="1"><?= esc(lang('Backoffice.cmp_wizard_edit')) ?></button>
                            </header>
                            <dl>
                        ...
                        <article class="bo-wizard-review-card">
                            <header>
                                <h3><?= esc(lang('Backoffice.cmp_wizard_step2_title')) ?></h3>
                                <button type="button" class="btn btn-link btn-sm" data-wizard-edit="2"><?= esc(lang('Backoffice.cmp_wizard_edit')) ?></button>
                            </header>
                            <dl>
                        ...
                        <article class="bo-wizard-review-card">
                            <header>
                                <h3><?= esc(lang('Backoffice.cmp_wizard_step3_title')) ?></h3>
                                <button type="button" class="btn btn-link btn-sm" data-wizard-edit="3"><?= esc(lang('Backoffice.cmp_wizard_edit')) ?></button>
                            </header>
                            <dl>
                                ...
                                <?php if (! empty($hasWitness)): ?>
                                    <div class="bo-wizard-review-full"><dt><?= esc(lang('Backoffice.cmp_field_witnesses')) ?></dt><dd data-review="witness_ids">—</dd></div>
                                <?php endif; ?>
                            </dl>
                        </article>
                        <article class="bo-wizard-review-card">
                            <header>
                                <h3><?= esc(lang('Backoffice.cmp_wizard_step4_title')) ?></h3>
                                <button type="button" class="btn btn-link btn-sm" data-wizard-edit="4"><?= esc(lang('Backoffice.cmp_wizard_edit')) ?></button>
                            </header>
                            <dl>
...
window.JH_CMP_WIZARD_I18N = {
    progress: <?= json_encode(lang('Backoffice.cmp_wizard_progress')) ?>,
