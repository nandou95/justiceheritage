                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="jh-action-group">
                                        <button class="jh-action-btn" type="button"
                                                data-bs-toggle="tooltip"
                                                data-bs-placement="top"
                                                title="<?= esc(lang('Portal.case_download')) ?>"
                                                aria-label="<?= esc(lang('Portal.case_download')) ?>">
                                            <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 4v10m0 0 3.5-3.5M12 14l-3.5-3.5M5 18h14" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                        </button>
                                    </div>
                                </td>
                            </tr>
