...
<section class="bo-panel bo-crud-panel">
    <form class="bo-filters" method="get" action="<?= site_url('backoffice/notifications/users') ?>" data-bo-user-filters
        ...
        <?= view('partials/bo_filters_head', [
            'filters' => $filters,
            'filterKeys' => [
                'canal_notification_id', 'statut_notification_id', 'province_id', 'commune_id',
                'niveau_juridiction_id', 'juridiction_id', 'utilisateur_id', 'profil_id', 'date_from', 'date_to',
            ],
            'resetUrl' => site_url('backoffice/notifications/users'),
