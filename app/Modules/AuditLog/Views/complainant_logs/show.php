...
<section class="bo-crud-head">
    <div>
        ...
        <h1><?= esc(lang('Backoffice.logs_complainant_details_title')) ?></h1>
        <p><?= esc(lang('Backoffice.logs_complainant_details_lead')) ?></p>
    </div>
    <a class="btn btn-bo-secondary" href="<?= site_url('backoffice/system-logs/complainants') ?>">
...
<section class="bo-panel bo-crud-panel">
    <h2 class="bo-form-section-title"><?= esc(lang('Backoffice.logs_section_complainant')) ?></h2>
    <dl class="bo-detail-list">
        <div><dt><?= esc(lang('Backoffice.logs_col_complainant')) ?></dt><dd><?= esc($record['complainant_name']) ?></dd></div>
        <div><dt><?= esc(lang('Backoffice.users_col_cni')) ?></dt><dd><?= esc($record['complainant_cni'] ?: '—') ?></dd></div>
        <div><dt><?= esc(lang('Backoffice.users_col_contact')) ?></dt><dd><?= esc($record['complainant_email'] ?: '—') ?><br><small><?= esc($record['complainant_phone'] ?: '') ?></small></dd></div>
        <div><dt><?= esc(lang('Backoffice.logs_field_username')) ?></dt><dd><?= esc($record['complainant_username'] ?: '—') ?></dd></div>
    </dl>
