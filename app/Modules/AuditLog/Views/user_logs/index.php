...
<section class="bo-panel bo-crud-panel">
    <form class="bo-filters" method="get" action="<?= site_url('backoffice/system-logs/users') ?>" data-bo-user-filters
        ...
        <?= view('partials/bo_filters_head', [
            'filters' => $filters,
            'filterKeys' => [
                'province_id', 'commune_id', 'niveau_juridiction_id', 'juridiction_id',
                'utilisateur_id', 'profil_id', 'action', 'table_cible', 'date_from', 'date_to',
            ],
            'resetUrl' => site_url('backoffice/system-logs/users'),
