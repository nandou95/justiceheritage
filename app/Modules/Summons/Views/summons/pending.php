...
<section class="bo-panel bo-crud-panel">
    <form class="bo-filters" method="get" action="<?= site_url('backoffice/summons/pending') ?>" data-bo-sum-filters
        ...
        <?= view('partials/bo_filters_head', [
            'filters' => $filters,
            'filterKeys' => ['niveau_juridiction_id', 'province_id', 'commune_id', 'juridiction_id', 'date_depot'],
            'resetUrl' => site_url('backoffice/summons/pending'),
                ...
                <tr>
                    ...
                    <td>
                        <div class="bo-action-group">
                            ...
                            <?php endif; ?>
                            <?php if (can_access('backoffice/summons/generate')): ?>
