    ...
    document.querySelectorAll("form.bo-filters").forEach((form) => {
      ...
      const reloadList = async () => {
        ...
        try {
          ...
          const headMeta = form.querySelector(".bo-filters-head-meta");
          const nextHeadMeta = doc.querySelector("form.bo-filters .bo-filters-head-meta");
          if (headMeta && nextHeadMeta) {
            headMeta.innerHTML = nextHeadMeta.innerHTML;
          }
